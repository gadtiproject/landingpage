  ...
  return (
    ...
    <div className="grid lg:grid-cols-3 font-[poppins] text-white m-10  justify-center items-center text-center gap-3">
        ...
        <div className="p-3" data-aos="fade-up">
          ...
          <h1 className="font-bold text-black dark:text-white mt-2">Ogunnaike Wahab B</h1>
        ...
        <div className="p-3" data-aos="fade-up">
            ...
            <h1 className="font-bold text-black dark:text-white mt-2">Akanji Oluwaleke J</h1>
        ...
        <div className="p-3" data-aos="fade-up">
          ...
          <h1 className="font-bold text-black dark:text-white mt-2">Egwuenu Precious </h1>
