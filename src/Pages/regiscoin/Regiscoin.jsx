  ...
  return (
    <div name="Regiscoin" className="pt-5 dark:bg-[#070909] bg-gray-100 ">
      ...
      <div className="dark:bg-[#0C1017] p-8 bg-[#fff]">
        <div className="justify-center items-center place-items-center grid">
          <h1 className="lg:text-5xl text-3xl text-center mt-3 dark:text-white font-bold tracking-wide mb-5 pt-5 text-black">
            Token Distribution
          </h1>
          <div className="lg:m-20 text-start m-5 md:w-[500px] lg:w-[800px] w-[360px]">
        ...
        <div className="justify-center items-center place-items-center grid">
          ...
          <p className="text-x text-center mt-2 dark:text-white italic tracking-wide mb-3 w-[360px] md:w-[500px] lg:w-[800px]">
            There will be 10% transaction fee of our token, which are as
            follows:
          </p>
          <div className="lg:m-10 text-start m-5 md:w-[500px] lg:w-[800px] w-[360px]">
