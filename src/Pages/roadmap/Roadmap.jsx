...
function Roadmap() {
  ...
  return (
    <div
      name="roadmap"
      className="text-white  dark:bg-[#070909] bg-[#f0f0f1]"
    >
      ...
      <Carousel responsive={responsive} autoPlay autoPlaySpeed={3000} className="h-[500px]">
        ...
        <div className="flex place-items-center justify-center items-center">
          <div className="roadmap__milestone w-[300px] h-[400px] lg:w-[400px] lg:h-[300px] overflow-scroll bg-[#02383C] dark:bg-white">
            <div className="roadmap__milestone-description">
              <h5 className="text-end text-white dark:text-black date">
                Q3 -2023
              </h5>
