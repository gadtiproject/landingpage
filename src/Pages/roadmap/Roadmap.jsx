...
function Roadmap() {
  ...
  const data = [
    ...
    },
    {
      ...
      para2: "Contract Audit",
      sub2: " Our contract will get audited by TBD",
      para3: "Multi-network profiles",
      sub3: "Track on ETH & BSC Networks",
      para4: "Buyback integration",
            ...
            return (
              <div key={id}>
                <div className="flex place-items-center justify-center items-center px-[25px]">
                  <div className="roadmap__milestone w-[300px] lg:w-[400px] lg:h-[300px] bg-[#02383C] dark:bg-white overflow-scroll">
