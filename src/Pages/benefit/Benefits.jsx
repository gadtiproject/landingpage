          ...
          <div className="gap-5">
            ...
            <div className="flex md:grid-cols-2 mt-5">
              ...
              <div className="grid">
                ...
                <p className="text-black mt-2 text-base tracking-wide text-start dark:text-[#fff]">
                  Verified true digital copy of uploaded document with a badge.
                </p>
              </div>
            </div>
            ...
            <div className="flex md:grid-cols-2 mt-5">
              ...
              <div className="grid">
                ...
                <p className="text-black mt-2 text-base tracking-wide text-start dark:text-[#fff]">
                  Give access to people to confirm the Genuity of your
                  documents.
                </p>
              </div>
            </div>
          ...
          <div className="gap-5">
            <div className="flex md:grid-cols-2 mt-5">
              ...
              <div className="grid">
                ...
                <p className="text-black mt-2 text-base tracking-wide text-start dark:text-[#fff]">
                  Control Third-party access with via App.
                </p>
              </div>
            </div>
            ...
            <div className="flex md:grid-cols-2 mt-5">
              ...
              <div className="grid">
                ...
                <p className="text-black mt-2 text-base tracking-wide text-start dark:text-[#fff]">
                  Instant access to document on the move.{" "}
                </p>
              </div>
            </div>
            ...
            <div className="flex md:grid-cols-2 mt-5">
              ...
              <div className="grid">
                ...
                <p className="text-black mt-2 text-base tracking-wide text-start dark:text-[#fff]">
                  Documents are Searchable and verifiable globally
                </p>
              </div>
            </div>
          </div>
